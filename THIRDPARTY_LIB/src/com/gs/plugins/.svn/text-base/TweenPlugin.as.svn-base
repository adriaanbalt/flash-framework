...
USAGE:
	...
	to keep in mind:
		...
		- IMPORTANT: The plugin core is brand new, so there is a chance that it will change slightly over time and 
		  you may need to adjust your custom plugins if the core changes. I'll try to minimize the changes,
...
package com.gs.plugins {
	...
	public class TweenPlugin {
		...
		public static const API:Number = 1.0; //If the API/core for plugins changes in the future, this number helps determine compatibility

...
*/
package com.stimuli.mona.validators{
    /*// usage
    * import com.stimuli.mona.validators.EmailValidator;
    * 
    ...
    */
    public class EmailValidator{
        ...
        *  @return <code>True</code> if the given string is a valid email address, <code>false</code> otherwise.
        */

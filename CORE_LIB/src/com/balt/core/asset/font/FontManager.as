package com.balt.core.asset.font
{
	...
	public class FontManager extends BulkLoaderUtil implements IContentManager
	{
		// connects to SiteLoader
		private var data : Object;		
		
		public function FontManager( $data:Object )
		{
			data = $data;
			
			// TODO begin load based on data passed, use the pathmanager to setup the correct paths for the files and then pass as an array into LOAD()
		}

...
package com.balt.core.address {
    ...
    import com.balt.core.address.SWFAddressEvent;
    ...
    public class SWFAddress {
        ...
        public static function popup(url:String, name:String='popup', options:String='""', handler:String=''):void {
            if (_availability && (Capabilities.playerType == 'ActiveX' || ExternalInterface.call('asual.com.balt.util.Browser.isSafari'))) {
        ...
        /**
         * Sets a function for page view metrics. The default value is 'urchinTracker'.
